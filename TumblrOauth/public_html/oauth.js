...
callback("https://api.tumblr.com/oauth/authorize?oauth_token="+self.request.token+"&oauth_token_secret="+self.request.tokenSecret+"&oauth_callback_confirmed=true");
...
action: "https://api.tumblr.com/oauth/access_token",
